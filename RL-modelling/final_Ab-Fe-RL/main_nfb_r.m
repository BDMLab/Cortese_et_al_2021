...
numsub  = size(Mydata_rel,1);
f       = fieldnames(Mydata_rel{1,1});
maxB    = 8;
ctr     = 1;
...
for tr=1: maxB
    ...
    subidx = ~cellfun(@isempty, Mydata_rel(:,tr));
...
save('Mf_nfb_r.mat', 'MF','MFall')
save('NLL_nfb_r.mat','NLL')
save('Theta_nfb_r.mat','Theta')
